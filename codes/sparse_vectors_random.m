...
function [MSIE_original,MSIE_paper] =  sparse_vectors_random(max_sparsity,flag)
% check data
% f = 0.1;
% N = 10;
% no_iter = 2;
...
ylabel('RRMSE');
temp = strcat(int2str(flag),'-random_RRMSE_synthetic data_maximum sparsity=',int2str(max_sparsity),'N=',int2str(N),'.png');
saveas(gcf,temp);
